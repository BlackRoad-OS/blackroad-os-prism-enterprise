...
export function AgentTable({ agents, isLoading = false }: AgentTableProps) {
  const hasAgents = agents.length > 0;

  return (
    <div className="overflow-hidden rounded-xl border border-slate-800 bg-slate-900/60">
      <table className="min-w-full divide-y divide-slate-800" aria-busy={isLoading}>
        <caption className="sr-only">Agent operational status overview</caption>
