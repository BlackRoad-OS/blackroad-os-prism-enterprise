...
export const metadata: Metadata = {
  ...
  keywords: ["AI API", "agent SDK", "autonomous agents", "AI integration", "agent framework", "API development", "AI platform", "agent orchestration"],
  authors: [{ name: "Blackroad AI Team" }],
  creator: "Blackroad AI",
  openGraph: {
    type: "website",
    locale: "en_US",
