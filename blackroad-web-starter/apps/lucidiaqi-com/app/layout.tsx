...
export const metadata: Metadata = {
  ...
  keywords: ["AI personas", "narrative design", "storytelling AI", "character development", "synthetic personas", "narrative intelligence", "story generation"],
  authors: [{ name: "Lucidia QI Team" }],
  creator: "Lucidia QI",
  openGraph: {
    type: "website",
    locale: "en_US",
