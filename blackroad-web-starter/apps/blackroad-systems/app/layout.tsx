...
export const metadata: Metadata = {
  ...
  keywords: ["infrastructure security", "cloud security", "system architecture", "DevSecOps", "secure deployment", "infrastructure automation", "security platform"],
  authors: [{ name: "Blackroad Systems Team" }],
