...
export const metadata: Metadata = {
  ...
  keywords: ["deployment platform", "agent hosting", "cloud deployment", "platform as a service", "agent bootcamp", "developer platform", "agent marketplace"],
  authors: [{ name: "Lucidia Earth Team" }],
  creator: "Lucidia Earth",
  openGraph: {
    type: "website",
    locale: "en_US",
