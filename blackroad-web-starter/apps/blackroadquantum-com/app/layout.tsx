...
export const metadata: Metadata = {
  ...
  keywords: ["quantum computing", "quantum algorithms", "quantum simulation", "quantum ML", "quantum optimization", "quantum research", "quantum technology"],
  authors: [{ name: "Blackroad Quantum Team" }],
  creator: "Blackroad Quantum",
  openGraph: {
    type: "website",
    locale: "en_US",
