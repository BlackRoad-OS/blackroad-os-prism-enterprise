...
export const metadata: Metadata = {
  ...
  keywords: ["quantum intelligence", "AI research", "cognitive computing", "intelligence platform", "research analytics", "data intelligence", "knowledge synthesis"],
  authors: [{ name: "Blackroad QI Team" }],
  creator: "Blackroad QI",
  openGraph: {
    type: "website",
    locale: "en_US",
